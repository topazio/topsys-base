...
public final class TSUtil {
	 ...
	 * 
	 * <p>
	 * Defaults to <code>null</code> if the runtime does not have security access to
	...
	/**
	 * <p>
	 * The <code>java.runtime.name</code> System Property. Java Runtime Environment
	 * name.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * The <code>java.vm.specification.version</code> System Property. Java Virtual
	 ...
	 * TSStringUtil.replace(strCpf, ".", ""); strCpf = TSStringUtil.replace(strCpf,
	 * "-", "");
	 * 
	 * int d1, d2; int digito1, digito2, resto; int digitoCPF; String nDigResult;
	 * 
	 ...
	 * calculado no passo anterior. d2 = d2 + (12 - nCount) * digitoCPF; } ;
	 * 
	 * // Primeiro resto da divis�o por 11. resto = (d1 % 11);
	 * 
	 * // Se o resultado for 0 ou 1 o digito � 0 caso contr�rio o digito � 11 //
	 * menos o resultado anterior. if (resto < 2) { digito1 = 0; } else { digito1 =
	 * 11 - resto; }
	 * 
	 * d2 += 2 * digito1;
	 * 
	 * // Segundo resto da divis�o por 11. resto = (d2 % 11);
	 * 
	 * // Se o resultado for 0 ou 1 o digito � 0 caso contr�rio o digito � 11 //
	 * menos o resultado anterior. if (resto < 2) { digito2 = 0; } else { digito2 =
	 * 11 - resto; } // Digito verificador do CPF que est� sendo validado. String
